-- Remote enrollment invitation system
...
CREATE INDEX IF NOT EXISTS idx_invitation_token ON enrollment_invitations(invitation_token);
CREATE INDEX IF NOT EXISTS idx_invitation_employee ON enrollment_invitations(fk_employee_id);
CREATE INDEX IF NOT EXISTS idx_invitation_status ON enrollment_invitations(status);
CREATE INDEX IF NOT EXISTS idx_invitation_approval ON enrollment_invitations(approval_status);
...
CREATE INDEX IF NOT EXISTS idx_session_invitation ON enrollment_session_progress(fk_invitation_id);
...
DROP TRIGGER IF EXISTS trigger_update_enrollment_invitation_timestamp ON enrollment_invitations;
