...
# Configuration
LOG_FILE="/home/administrator/FRS_/FRS--Java-Verison/logs/monitor.log"
...
if curl -sf --max-time 10 http://localhost:8080/api/health > /dev/null; then
    ...
    cd /home/administrator/FRS_/FRS--Java-Verison
...
if [ "$DISK_USAGE" -gt 90 ]; then
    ...
    du -h /home/administrator/FRS_/FRS--Java-Verison 2>/dev/null | sort -rh | head -10 | tee -a "$LOG_FILE"
